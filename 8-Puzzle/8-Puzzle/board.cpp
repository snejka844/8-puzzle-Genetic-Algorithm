//The gene data structure for each puzzle state.
//The encoding and decoding of each puzzle into an integer and array are located in this file.
//Logic for movement of tiles and fitness calculations are also located here.
#include <bitset>
#include <iostream>
#include <stdio.h>
#include <stdlib.h>
...
{
	fitness = 1 - getManhattan()*.01 - getTopLeft()*.02;
}
